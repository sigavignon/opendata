...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="gmd:MD_Metadata">  
		...
		<br/>
		<img style="width: 240px; height: 70px;" alt="Mairie Avignon" src="http://upload.wikimedia.org/wikipedia/fr/thumb/b/bb/Logo_Avignon.svg/320px-Logo_Avignon.svg.png"/>
		<br/>		
		<br/>
Fiche générée le 
		...
		<table>
			...
			<tr>
				<td class="td1">RS Identifiant :</td>
				<td class="titre td2"> <xsl:value-of select="gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:RS_Identifier/gmd:code/gco:CharacterString"/> </td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="titre td2"> 
					...
					<xsl:if test="contains($MyType, 'dataset')">Jeu de données</xsl:if>
					<xsl:if test="contains($MyType, 'series')">Ensemble de jeux de données</xsl:if>
		...
		<table>
			...
			<tr>
				...
				[<u>vocabulaire contrôlé</u> : <i><xsl:value-of select="gmd:thesaurusName/gmd:CI_Citation/gmd:title/gco:CharacterString"/></i> -  
